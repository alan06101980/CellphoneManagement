...
Public Class frmReporteCerrados
...
#End Region
    ...
    Private Sub frmReporteCerrados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        ...
        Try
            ...
            Dim consulta As New SqlCeDataAdapter("SELECT IDHISTORIAL AS CÓDIGO, HISTORIAL.IDTELEFONO AS NÚMERO, PROVEEDOR AS PROVEEDOR, NOMBREUSUARIO AS USUARIO, FECHA_HISTORIAL AS FECHA_INCIDENTE, ESTATUS_HISTORIAL AS ESTATUS, CATEGORIA AS CATEGORIA, FECHA_CIERRE AS FECHA_CIERRE, MONTO_HISTORIAL AS MONTO, DESC_HISTORIAL AS DESCONTADO, INCIDENTE_HISTORIAL AS INCIDENTE FROM TELEFONO INNER JOIN HISTORIAL ON TELEFONO.IDTELEFONO=HISTORIAL.IDTELEFONO INNER JOIN CATEGORIAS ON HISTORIAL.IDCATEGORIA=CATEGORIAS.IDCATEGORIA INNER JOIN PROVEEDOR ON PROVEEDOR.IDPROVEEDOR=TELEFONO.IDPROVEEDOR WHERE ESTATUS_HISTORIAL = 'CERRADO' AND FECHA_HISTORIAL >= @FECHAINICIAL AND FECHA_HISTORIAL <= @FECHAFINAL ORDER BY FECHA_HISTORIAL", cn)
            ...
            If dt_consulta.Rows.Count > 0 Then
                ...
                Me.DataGridView1.Columns(9).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
                Me.DataGridView1.Columns(10).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
                Me.DataGridView1.Columns(1).Width = 70
                Me.DataGridView1.Columns(2).Width = 70
                Me.DataGridView1.Columns(3).Width = 180
                Me.DataGridView1.Columns(6).Width = 180
                Me.DataGridView1.Columns(10).Width = 600
            Else
            ...
            If DataGridView1.Rows.Count > 0 Then
                ...
                For x = 0 To DataGridView1.SelectedRows.Count - 1
                    ...
                    Using tran1 As New Transactions.TransactionScope(TransactionScopeOption.Required, transactionOptions)
                        ...
                        'Consultar en la base de datos si existe un valor con fecha mayor que esté con categoria 'DAR DE BAJA'
                        'Falta realizar ese control

                        Dim reabrir As New SqlCeCommand("UPDATE HISTORIAL SET ESTATUS_HISTORIAL='ABIERTO', FECHA_CIERRE=@FECHA_CIERRE WHERE IDHISTORIAL=@IDHISTORIAL", cn)
                        reabrir.CommandType = CommandType.Text
                        reabrir.Parameters.AddWithValue("@IDHISTORIAL", DataGridView1.SelectedRows(x).Cells(0).Value)
                        reabrir.Parameters.AddWithValue("@FECHA_CIERRE", DBNull.Value)
                        reabrir.ExecuteNonQuery()
                        ...
                        cn.Close()
                        tran1.Dispose()
                        MsgBox("Se ha reabierto el caso seleccionado.", MsgBoxStyle.Information, "Aviso")
                        btnConsultar_Click(sender, e)

                    End Using
                Next
            Else
                MsgBox("Seleccione una fila para actualizar.", MsgBoxStyle.Exclamation, "Error")
                Exit Sub
            End If
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        f3.cboNumero.Text = Me.DataGridView1.SelectedCells(1).Value.ToString
