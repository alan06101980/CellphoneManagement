...
Public Class frmReporteIncidentesTotales
...
#End Region
    ...
    Private Sub frmReporteIncidentesTotales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        ...
        Try
            ...
            Dim consulta As New SqlCeDataAdapter("SELECT HISTORIAL.IDTELEFONO AS NÚMERO, NOMBREUSUARIO AS USUARIO, PROVEEDOR AS PROVEEDOR, FECHA_HISTORIAL AS FECHA_INCIDENTE, ESTATUS_HISTORIAL AS ESTATUS, CATEGORIA AS CATEGORIA, MONTO_HISTORIAL AS MONTO, DESC_HISTORIAL AS DESCONTADO, INCIDENTE_HISTORIAL AS INCIDENTE FROM HISTORIAL INNER JOIN CATEGORIAS ON HISTORIAL.IDCATEGORIA=CATEGORIAS.IDCATEGORIA INNER JOIN TELEFONO ON HISTORIAL.IDTELEFONO=TELEFONO.IDTELEFONO INNER JOIN PROVEEDOR ON TELEFONO.IDPROVEEDOR=PROVEEDOR.IDPROVEEDOR WHERE FECHA_HISTORIAL >= @FECHAINICIAL AND FECHA_HISTORIAL <= @FECHAFINAL ORDER BY FECHA_HISTORIAL", cn)
